...
namespace Snowdrama
{
    public class Iterator
    {
        ...
        [SerializeField, Tooltip("How long to iterate for before stopping, less than 0 = forever")] private float duration; //how long to iterate for before stopping, less than 0 = forever
